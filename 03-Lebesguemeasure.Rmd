...
We call a set $A \in \mathscr{P}(\mathbb{R})$ *Lebesgue Measureable* if for any $B \in \mathscr{P}(\mathbb{R})$ we have 
...
::: {.definition name="Ring - NONEXAMINABLE"}
...
::: {.theorem name="Carathéodory's Extension Theorem - NONEXAMINABLE"}
